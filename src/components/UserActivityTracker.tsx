...
const UserActivityTracker = memo(function UserActivityTracker() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Activity Summary</h1>
        <p className="text-gray-600">Your activity and engagement insights</p>
      </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{summary.totalSearches}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{summary.totalEventViews}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{summary.totalSavedEvents}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Most Searched Terms */}
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Most Searched Terms</h2>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Most Viewed Industries</h2>
          {summary.mostViewedIndustries.length > 0 ? (
            ...
            <p className="text-sm text-gray-500">No industry preferences yet</p>
          )}
        </div>
      </div>
