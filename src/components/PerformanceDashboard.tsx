        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          {summary && (
            <div className="space-y-6">
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="bg-white rounded-md p-3">
                      <div className="text-sm text-slate-500">First Contentful Paint</div>
              ...
              {metrics?.api && (
                <div className="bg-slate-50 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-slate-900 mb-4">API Performance</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white rounded-md p-3">
                      <div className="text-sm text-slate-500">Slow Requests</div>
                      <div className="text-2xl font-bold text-slate-900">
              ...
              {metrics?.interactions && (
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white rounded-md p-3">
                      <div className="text-sm text-slate-500">Avg Click Delay</div>
                      <div className="text-2xl font-bold text-slate-900">
                    ...
                    <div className="bg-white rounded-md p-3">
                      <div className="text-sm text-slate-500">Scroll Depth</div>
                      <div className="text-2xl font-bold text-slate-900">
                        {metrics.interactions.scrollDepth || 0}%
                      </div>
                    </div>
                    <div className="bg-white rounded-md p-3">
                      <div className="text-sm text-slate-500">Time on Page</div>
                      <div className="text-2xl font-bold text-slate-900">
              ...
              {summary.eventCounts && (
                <div className="bg-slate-50 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-slate-900 mb-4">Event Counts</h3>
