...
const NON_PERSON_TERMS = /\b(Summit|Forum|Panel|Track|Keynote|Workshop|Webinar|Session|Privacy|Compliance|Risk|Week|Faculty|Operations|Practices?|User|National|Symposium|Lawyers?|Conference|Konferenz|Tagung|Seminar|Day|Resource|Center|Centre|Library|Portal|Hub|Network|Instructor|Trainer|Teacher|Committee|Board|Team|Group|Department|Association|Institute|Foundation|Council|Society|Partner|Discovery|eDiscovery|Litigation|Investigation|Audit|Governance|Regulation|Technology|Management|Solution|Service|Program|Project|Strategy|Initiative|Januar|Februar|März|April|Mai|Juni|Juli|August|September|Oktober|November|Dezember|January|February|March|May|June|July|October|December|Not\s+found|Page\s+not\s+found|404)\b/i;
